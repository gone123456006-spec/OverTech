    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-8">
        ...
        <div className="flex items-center gap-2 text-sm md:text-base text-gray-600 mb-4 md:mb-6 overflow-x-auto">
          <Link to="/" className="hover:text-teal-900 whitespace-nowrap">Home</Link>
          <span>/</span>
          <Link to={`/category/${product.category}`} className="hover:text-teal-900 capitalize whitespace-nowrap">
            {product.category}
          </Link>
          <span>/</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 md:p-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                ...
                <span className={`text-sm md:text-lg ${product.stock > 0 ? 'text-teal-900' : 'text-red-600'}`}>
                  {product.stock > 0 ? `${product.stock} in stock` : 'Out of stock'}
                </span>
              </div>

              <div className="text-2xl md:text-3xl lg:text-4xl text-teal-900 font-bold mb-4 md:mb-6">
                ₹{product.price}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mt-auto">
                <button
                  ...
                  className="btn-outline flex-1 py-3 md:py-4 text-base md:text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={product.stock === 0}
                  className="btn-primary flex-1 py-3 md:py-4 text-base md:text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Buy Now
                </button>
              </div>
